# coding: utf-8
#
# Json is the default storage option for looper. It writes a Json file to
# ~/.looper. Pretty neat, huh?
#
module Looper
  module Storage
    class Json < Base

      JSON_FILE = "#{ENV['HOME']}/.looper"

      # Public: the path to the Json file used by looper.
      #
